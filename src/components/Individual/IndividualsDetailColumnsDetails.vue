<template>
  <q-card-section class="q-px-none" v-if="code !== 'NEW'">
    ...
    <div style="height: 80px" class="q-px-xl" v-if="updates.indexOf(code) > -1"><q-btn color="primary" label="Update" class="full-width" @click="clicked = true; $emit('push')" :loading="loading" /></div>
