<template>
  <div class="row q-col-gutter-sm">
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" v-for="Company in resellerCompanies">
    ...
    <div v-if="!resellerCompanies.length" class="col-12 text-center">no companies assigned yet..</div>
  </div>
</template>
...
const resellerCompanies = computed(() => filter(companyStore.Companies,['created_by',props.reseller_id]))
